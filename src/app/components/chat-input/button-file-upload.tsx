...
export function ButtonFileUpload({
  ...
  const isFileUploadAvailable = true // Allow for all models
  ...
  return (
    <FileUpload
      ...
      multiple
      accept=".txt,.md,.json,.js,.ts,.tsx,.jsx,.py,.c,.cpp,.h,.css,.html,.java,.go,.rs,.sql,image/jpeg,image/png,image/gif,image/webp,image/svg,image/heic,image/heif"
    >
      <Tooltip>
        <TooltipTrigger asChild>
