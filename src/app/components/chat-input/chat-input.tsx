...
function StopSvgIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
  ...
  useMemo(() => {
    if ((!hasSearchSupport || hideSearch) && enableSearch) {
      setEnableSearch?.(false)
    }
  }, [hasSearchSupport, hideSearch, enableSearch, setEnableSearch])
