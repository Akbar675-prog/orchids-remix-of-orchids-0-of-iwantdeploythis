...
const grokModels: ModelConfig[] = [
  ...
  },
  {
    ...
    },
    {
      ...
      modelFamily: "Grok",
      baseProviderId: "xai",
      description: "Massive xAI model with elite reasoning capabilities.",
      ...
      icon: "xai",
      apiSdk: (apiKey?: string) =>
        openproviders("grok-4-heavy", undefined, apiKey),
    },
    {
      id: "grok-4",
      name: "Grok 4",
      ...
      modelFamily: "Grok",
      baseProviderId: "xai",
      description: "Latest Grok model with significantly improved reasoning.",
      tags: ["next-gen", "reasoning", "flagship"],
      contextWindow: 1000000,
      inputCost: 5.0,
      outputCost: 20.0,
      priceUnit: "per 1M tokens",
      ...
      icon: "xai",
      apiSdk: (apiKey?: string) =>
        openproviders("grok-4", undefined, apiKey),
    },
  ]
