  ...
  },
  {
  ...
  },
    {
      ...
      },
      {
        ...
        modelFamily: "Gemini",
        baseProviderId: "google",
        description: "Next-gen Gemini 3 Flash for extreme speed and efficiency.",
        tags: ["next-gen", "fast", "efficient"],
        contextWindow: 2000000,
        inputCost: 0.05,
        outputCost: 0.2,
        priceUnit: "per 1M tokens",
...

    {
      ...
      modelFamily: "Gemini",
      baseProviderId: "google",
      description: "Flagship Gemini 3 Pro with superhuman reasoning.",
      ...
      icon: "gemini",
      apiSdk: (apiKey?: string) =>
        openproviders("gemini-3.0-pro", undefined, apiKey),
    },
    {
      id: "gemma-3-27b-it",
