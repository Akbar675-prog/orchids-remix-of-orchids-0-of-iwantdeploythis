...
export const openrouterModels: ModelConfig[] = [
    {
      ...
      description:
        "OpenAI's latest flagship model, balanced for speed and intelligence.",
    ...
    {
      id: "openrouter:openai/gpt-5.2-preview",
      name: "GPT 5.2",
      provider: "OpenRouter",
      providerId: "openrouter",
      modelFamily: "GPT",
      baseProviderId: "openai",
      description:
        "Next-generation GPT model with revolutionary reasoning and multimodal understanding.",
      tags: ["next-gen", "reasoning", "advanced"],
      ...
      website: "https://openrouter.ai",
      apiDocs: "https://openrouter.ai/openai/gpt-5.2-preview",
      modelPage: "https://openai.com",
      icon: "openai",
      apiSdk: (apiKey?: string) =>
        createOpenRouter({
          apiKey: apiKey || process.env.OPENROUTER_API_KEY,
        }).chat("openai/gpt-5.2-preview"),
    },
    {
      id: "openrouter:x-ai/grok-4-heavy",
      name: "Grok 4 Heavy",
      provider: "OpenRouter",
      providerId: "openrouter",
      modelFamily: "Grok",
      baseProviderId: "xai",
      description:
        "xAI's most powerful model yet, designed for massive-scale reasoning and deep knowledge synthesis.",
      tags: ["flagship", "reasoning", "synthesis"],
      contextWindow: 200000,
      inputCost: 5.0,
      outputCost: 20.0,
      priceUnit: "per 1M tokens",
      ...
      intelligence: "Extreme",
      website: "https://openrouter.ai",
      apiDocs: "https://openrouter.ai/x-ai/grok-4-heavy",
      modelPage: "https://x.ai",
      icon: "xai",
      apiSdk: (apiKey?: string) =>
        createOpenRouter({
          apiKey: apiKey || process.env.OPENROUTER_API_KEY,
        }).chat("x-ai/grok-4-heavy"),
    },
    {
