...
const claudeModels: ModelConfig[] = [
  ...
  },
  {
    ...
    },
    {
      ...
      baseProviderId: "claude",
      description:
        "The most powerful Claude model ever built, with superior reasoning.",
      tags: ["next-gen", "reasoning", "advanced", "flagship"],
      ...
      icon: "claude",
      apiSdk: (apiKey?: string) =>
        openproviders("claude-4.5-opus", undefined, apiKey),
    },
      {
        ...
        baseProviderId: "claude",
        description:
          "Balanced Claude 4.5 model with exceptional intelligence and speed.",
        tags: ["next-gen", "balanced", "reasoning"],
        contextWindow: 1000000,
        inputCost: 10.0,
        outputCost: 50.0,
        priceUnit: "per 1M tokens",
        ...
        icon: "claude",
        apiSdk: (apiKey?: string) =>
          openproviders("claude-4.5-sonnet", undefined, apiKey),
      },
      {
        id: "claude-opus-4.6",
        ...
        baseProviderId: "claude",
        description:
          "Next-gen Claude Opus model with upgraded reasoning and accuracy.",
        tags: ["next-gen", "reasoning", "advanced", "flagship"],
        contextWindow: 1000000,
        inputCost: 55.0,
        outputCost: 275.0,
