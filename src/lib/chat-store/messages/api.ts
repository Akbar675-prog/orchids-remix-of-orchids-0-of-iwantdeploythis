...
export async function addMessage(
  ...
  // await insertMessageToDb(chatId, message) // Backend handles Supabase persistence
...
export async function setMessages(
  ...
  // await insertMessagesToDb(chatId, messages) // Backend handles Supabase persistence
  await writeToIndexedDB("messages", { id: chatId, messages })
}
