...
export function UserPreferencesProvider({
  ...
  const setReceiveNotifications = (enabled: boolean) => {
    updatePreferences({ receiveNotifications: enabled })
  }
  ...
  const setTtsVoice = (voiceId: string) => {
    updatePreferences({ ttsVoice: voiceId })
  }
